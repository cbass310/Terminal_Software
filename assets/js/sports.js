...
function openAiModal(slipId) {
    ...
    const html = `
        <div class="bg-studio/95 border border-white/10 rounded-2xl p-6 shadow-2xl relative overflow-hidden w-full max-w-md mx-auto">
            <button onclick="closeAiModal()" class="absolute top-3 right-3 text-slate-500 hover:text-white bg-black/50 p-1.5 rounded-full transition-colors z-50 cursor-pointer">
            ...
            <button onclick="closeAiModal()" class="w-full mt-6 bg-white/10 hover:bg-white/20 text-white font-black py-3 rounded-xl transition-all duration-300 uppercase tracking-widest text-xs cursor-pointer">
                Acknowledge
            </button>
        </div>
    `;
