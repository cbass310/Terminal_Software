...
// Cache for the Deep Dive Modals
window.dfsCache = {};
...
// --- PLATFORM FILTER LOGIC FOR PREMIUM SLIP ---
...
// --- DEEP DIVE MODAL LOGIC (DFS PROP CARDS) ---
...
function openDfsModal(edgeId) {
    ...
    const platformLogoHtml = getSportsbookLogo(platformName, "w-16 h-5 object-contain");
...
function createOptimizedSlipCard() {
    ...
    // Interactive Platform Toggle inside the slip area
    const tabsHtml = `
